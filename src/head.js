function Head(){
    ...
    return(
        ...
        <p class="header">
          ...
          &nbsp;<span id="info">Komal Nimbalkar </span>  &nbsp; &nbsp; &nbsp;
          <svg
          ...
          &nbsp;<span id="info"> nandinideshmukh222@gmail.com </span> &nbsp;&nbsp;
          <a href="assets/kirancv24 (2).pdf" id="RESUME" download> 
